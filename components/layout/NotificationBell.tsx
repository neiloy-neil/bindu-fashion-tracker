...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="absolute right-0 top-11 w-80 max-h-[480px] overflow-y-auto rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-2xl z-[200] flex flex-col">
          {/* Header */}
