    ...
    return (
      <Link
        ...
        className={cn(
          ...
          'transition-colors duration-150 w-full relative',
          isActive
      ...
      >
        <span className="w-[18px] h-[18px] flex-shrink-0 flex items-center justify-center opacity-80">
          {icon}
        </span>
        <span className="flex-1 truncate">{label}</span>
        {badge ? (
          <span className="text-[10px] font-bold bg-[var(--danger)] text-white rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 flex-shrink-0">
            {badge > 99 ? '99+' : badge}
          </span>
        ) : null}
      </Link>
    ...
    <>
      ...
      <aside className={`sidebar z-50 ${isOpen ? 'mobile-open' : ''}`}>
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3 space-y-0.5">
          ...
          {/* Main */}
          <p className="text-[10px] font-semibold text-[var(--text-muted)] uppercase tracking-widest px-3 pt-2 pb-1.5">
            Main
          </p>
          {navItem('/', 'Dashboard', (
          ...
          {role !== 'HR_ADMIN' && (
            <>
              <p className="text-[10px] font-semibold text-[var(--text-muted)] uppercase tracking-widest px-3 pt-4 pb-1.5">
                Cash Flow
              </p>
