    ...
    <View style={s.slip}>
      ...
      <View style={s.table}>
        ...
        <View style={s.tRow}>
          ...
          <Cell style={s.tQty}></Cell>
          <Cell style={s.tOp}>(-)</Cell>
          <Cell style={s.tAmt}>{fmt(branchAdvance)}</Cell>
        </View>
        ...
        <View style={s.tRow}>
          ...
          <Cell style={s.tQty}></Cell>
          <Cell style={s.tOp}>(-)</Cell>
          <Cell style={s.tAmt}>{fmt(hrAdvance)}</Cell>
        </View>
...
with open("d:/AI/bindu-fashion-tracker/components/hr/SalarySlipPDF.tsx", "w", encoding="utf-8") as f:
    f.write(salary_slip)
with open("d:/AI/bindu-fashion-tracker/components/hr/EidSlipPDF.tsx", "w", encoding="utf-8") as f:
    f.write(eid_slip)
